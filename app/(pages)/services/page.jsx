    ...
    <PageSection {...headerProps}>
      <div className="space-y-16">
        ...
        <motion.div 
          ...
          transition={{ duration: 0.8, delay: 0.2 }}
          viewport={{ once: true }}
          className="bg-gradient-to-r from-yellow-50 via-orange-50 to-yellow-50 dark:from-gray-800 dark:via-gray-800 dark:to-gray-800 rounded-2xl p-6 md:p-8 border border-yellow-200 dark:border-gray-700"
        >
          <div className="text-center space-y-4">
            ...
            >
              ...
              <h3 className="text-xl md:text-2xl font-bold text-gray-900 dark:text-white">
                {servicesData.pricingNote.title}
              </h3>
            </motion.div>
            ...
            >
              {servicesData.pricingNote.description}
            </motion.p>
            ...
            <motion.div 
              ...
              transition={{ duration: 0.6, delay: 0.4 }}
              viewport={{ once: true }}
              className="inline-flex items-center gap-2 bg-white/70 dark:bg-gray-700/70 px-4 py-2 rounded-full border border-yellow-300 dark:border-gray-600"
            >
              <span className="text-base font-medium text-gray-800 dark:text-gray-200">
                {servicesData.pricingNote.disclaimer}
              </span>
            </motion.div>
          </div>
        </motion.div>
