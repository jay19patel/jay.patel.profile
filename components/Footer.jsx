  ...
  return (
    ...
    >
      <motion.footer 
        ...
        viewport={{ once: true }}
        className="max-w-7xl mx-auto bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-2xl shadow-lg p-4 md:p-6 transition-colors duration-300"
      >
