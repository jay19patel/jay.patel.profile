...
export default function QnATab() {
  ...
  return (
    <div className="space-y-6">
        ...
        <CardContent className="space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="space-y-2">
              <Label htmlFor="new-qna-question">Question</Label>
              <Input
                id="new-qna-question"
                name="question"
            ...
            <div className="space-y-2">
              <Label htmlFor="new-qna-answer">Answer</Label>
              <Input
                id="new-qna-answer"
                name="answer"
                value={newQnA.answer}
            ...
            <div className="flex items-center gap-2 mt-2">
              ...
              <span className="text-sm text-gray-600">{newQnA.active ? 'Active' : 'Inactive'}</span>
            </div>
          </div>
          <Button
            onClick={handleAdd}
      ...
      <Card className="shadow-lg border-0 bg-white rounded-3xl">
        <CardHeader>
          <CardTitle className="text-lg text-gray-900">Your Q&A Items</CardTitle>
        </CardHeader>
        <CardContent>
              ...
              <div key={item.id} className="group p-4 bg-white border border-gray-200 rounded-2xl shadow-sm hover:shadow-md transition-all duration-200 space-y-2">
                <div className="flex items-center gap-4">
                  <div className="flex-1 min-w-0 space-y-2">
                    <Label htmlFor={`qna-question-${idx}`}>Question</Label>
                    <Input
                      id={`qna-question-${idx}`}
                      name="question"
                    ...
                    />
                    <Label htmlFor={`qna-answer-${idx}`}>Answer</Label>
                    <Input
                      id={`qna-answer-${idx}`}
                      name="answer"
