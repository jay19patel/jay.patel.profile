...
const ChatBot = () => {
  ...
  return (
    <>
      ...
      <button
        onClick={toggleChat}
        className="fixed bottom-8 right-8 bg-gray-900 dark:bg-gray-100 text-white dark:text-gray-900 p-4 rounded-full shadow-lg hover:bg-gray-800 dark:hover:bg-gray-200 transition-all duration-300 z-50 transform hover:scale-110"
